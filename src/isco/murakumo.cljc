...
(defn collection
  [name]
  (str "com.etzhayyim.isco." name))

(def cell-specs {
  :health {:legacy-cell "com-etzhayyim-apps-isco-health"
     :phase :event
  ...
  :get {:legacy-cell "com-etzhayyim-apps-isco-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :occupation {:legacy-cell "com-etzhayyim-apps-isco-occupation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "occupation")]
     :required-gates common-gates
     :trigger "manifest cell occupation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :workforcemobility {:legacy-cell "com-etzhayyim-apps-isco-workforceMobility"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "workforcemobility")]
     :required-gates common-gates
     :trigger "manifest cell workforcemobility"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
